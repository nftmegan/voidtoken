...
export const AppBar: FC = props => {
  ...
  return (
    <div className="">
      ...
      {/* NavBar / Header */}
      <div className="navbar flex flex-row md:mb-2 shadow-lg text-neutral-content bg-black bg-opacity-20">
        ...
        <div className="hidden md:inline md:navbar-center">
          <div className="flex items-stretch space-x-1">
            <Link href="/">
              <a className="btn btn-ghost btn-sm rounded-btn text-2xl">Home</a>
            </Link>
            {/* <Link href="/claim"> */}
				<a className="bg-airdropBtnColor p-2 btn-sm rounded-btn text-2xl flex text-gray-300 cursor-not-allowed">
