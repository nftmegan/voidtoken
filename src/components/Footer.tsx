...
export const Footer: FC = () => {
    return (
        <div className="">
            <footer className="mx-auto  flex flex-row p-2 text-center items-center footer bg-neutral text-neutral-content py-4">
				...
				<div className="grid-flow-col gap-4 text-center pr-2 text-2xl">
					<a>of.nothing.\</a>
                </div>
            </footer>
        </div>
